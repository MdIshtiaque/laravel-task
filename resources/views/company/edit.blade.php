...
<body>
    ...
    <div class="row">
        <div class="col-8 m-auto">
            ...
            <form action="{{ route('company.update', ['company' => $companies->id]) }}" method="POST">
                @method('PUT')
                @csrf
                ...
                is-invalid
                @enderror " value="{{ $companies->email }}"
                ...
                is-invalid
                @enderror " value="{{ $companies->website }}"
