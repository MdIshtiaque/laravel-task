    ...
    <div class="row">
        ...
        <div class="col-8 m-auto">
            ...
            <form action="{{ route('employee.update') }}" method="POST">
                ...
                is-invalid
                @enderror " value="{{ $emloyee->first_name }}
                ...
                is-invalid
                @enderror " value="{{ $emloyee->last_name }}
                    ...
                    <select class="form-select lg mt-4 mb-4 p-2" name="id">
                        ...
                        @foreach ($companies as $company)
                            <option value="{{ $company->id }}"
                                @if ($company->id == $employee->compnay_id)
                                    selected
                                @endif
                                >{{ $company->name }}</option>
                        @endforeach
